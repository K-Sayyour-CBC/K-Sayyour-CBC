...
CreateCustomer = CreateStatement("Customer")
CreateDate = CreateStatement("Date")
CreateEmpolyee = CreateStatement("Employee")
CreateProduct = CreateStatement("Product")
CreateSales = CreateStatement("Sales")

#Create Files That Include The Given Create Statement For Each Creation Case 
CreateFile("CreateCustomer.sql", CreateCustomer)
CreateNotExstFile("CreateNotExistDate.sql", CreateDate, "Date")
DropNCreateFile("DropNCreateEmployee.sql", CreateEmpolyee, "Employee")
TrunOrCreateFile("TrunOrCreateProduct.sql", CreateProduct, "Product")
CreateFile("CreateSales.sql", CreateSales)
